    ...
    public void modificar(){
        try {
            if (validarPrestamoModificar()== true) {
                eprestamo.fechaInicio = metodo.utilDatetoSqlDate(eprestamo.getFechaInicio().toString());
                eprestamo.fechaFin = metodo.utilDatetoSqlDate(eprestamo.getFechaFin().toString());
                eprestamo.fechaUltimoPago = metodo.utilDatetoSqlDate(eprestamo.getFechaUltimoPago().toString());
